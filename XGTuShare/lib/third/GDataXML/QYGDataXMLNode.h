...
_EXTERN const char* kQYGDataXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
enum {
    QYGDataXMLInvalidKind = 0,
    QYGDataXMLDocumentKind,
    QYGDataXMLElementKind,
    QYGDataXMLAttributeKind,
    QYGDataXMLNamespaceKind,
    QYGDataXMLProcessingInstructionKind,
    QYGDataXMLCommentKind,
    QYGDataXMLTextKind,
    QYGDataXMLDTDKind,
    QYGDataXMLEntityDeclarationKind,
    QYGDataXMLAttributeDeclarationKind,
    QYGDataXMLElementDeclarationKind,
    QYGDataXMLNotationDeclarationKind
};

typedef NSUInteger QYGDataXMLNodeKind;

@interface QYGDataXMLNode : NSObject <NSCopying> {
@protected
...
+ (QYGDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface QYGDataXMLElement : QYGDataXMLNode
...
- (QYGDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface QYGDataXMLDocument : NSObject {
@protected
